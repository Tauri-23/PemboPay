            ...
            <div class="long-cont d-flex justify-content-between align-items-center">
                <div class="d-flex gap3">
                    <div class="d-flex position-relative align-items-center">
                        ...
                        <input id="search-dept" class="edit-text-2" type="text" placeholder="Search Departments" autocomplete="off" />
                    </div>
                ...
                <a href="/AdminAddDepartment" class="primary-btn1-small d-flex align-items-center">
